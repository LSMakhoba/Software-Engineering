...
CREATE TABLE `ADDRESS` (
  ...
  CONSTRAINT `ADDRESS_ibfk_1` FOREIGN KEY (`PATIENT_ID`) REFERENCES `PATIENT` (`PATIENT_ID`)
...
CREATE TABLE `APPOINTMENT` (
  ...
  CONSTRAINT `APPOINTMENT_ibfk_3` FOREIGN KEY (`RECEPTIONIST_ID`) REFERENCES `RECEPTIONIST` (`RECEPTIONIST_ID`),
...
CREATE TABLE `AUTHORIZATION` (
  ...
  KEY `DOCTOR_ID` (`DOCTOR_ID`),
  KEY `RECEPTIONIST_ID` (`RECEPTIONIST_ID`),
  CONSTRAINT `AUTHORIZATION_ibfk_2` FOREIGN KEY (`RECEPTIONIST_ID`) REFERENCES `RECEPTIONIST` (`RECEPTIONIST_ID`),
  CONSTRAINT `AUTHORIZATION_ibfk_1` FOREIGN KEY (`DOCTOR_ID`) REFERENCES `DOCTOR` (`DOCTOR_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `CONSULTATION` (
  ...
  CONSTRAINT `CONSULTATION_ibfk_2` FOREIGN KEY (`INVOICE_ID`) REFERENCES `INVOICE` (`INVOICE_ID`),
  CONSTRAINT `CONSULTATION_ibfk_1` FOREIGN KEY (`APPOINTMENT_ID`) REFERENCES `APPOINTMENT` (`APPOINTMENT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MEDICAL_CONDTION` (
  ...
  KEY `PATIENT_ID` (`PATIENT_ID`),
  CONSTRAINT `MEDICAL_CONDTION_ibfk_1` FOREIGN KEY (`PATIENT_ID`) REFERENCES `PATIENT` (`PATIENT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PATIENT` (
  ...
  `ID_OR_PASSORT_NUMBER` int(11) NOT NULL,
  ...
  KEY `MED_CONDITION_ID` (`MED_CONDITION_ID`),
  CONSTRAINT `PATIENT_ibfk_2` FOREIGN KEY (`MED_CONDITION_ID`) REFERENCES `MEDICAL_CONDTION` (`MED_CONDITION_ID`),
...
-- Dump completed on 2018-09-18 15:36:09
